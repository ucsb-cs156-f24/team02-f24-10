...
public class UCSBDiningCommonsMenuItemWebIT extends WebTestCase {
    ...
    public void admin_user_can_create_edit_delete_menu_item() throws Exception {
        ...
        page.getByTestId("UCSBDiningCommonsMenuItemForm-diningCommonsCode").fill("asdf");
        page.getByTestId("UCSBDiningCommonsMenuItemForm-name").fill("potato");
        page.getByTestId("UCSBDiningCommonsMenuItemForm-station").fill("food");
        ...
        page.getByTestId("UCSBDiningCommonsMenuItemForm-name").fill("tomato");
        page.getByTestId("UCSBDiningCommonsMenuItemForm-submit").click();

        assertThat(page.getByTestId("UCSBDiningCommonsMenuItemTable-cell-row-0-col-name")).hasText("tomato");
